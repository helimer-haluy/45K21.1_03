...
public final class forgetPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div class=\"h4 text-muted text-center pt-2\">Forget Password</div>\n");
      out.write("                    \n");
      out.write("\t\t<form class=\"pt-3\" action=\"resetPassword\" method=\"post\">\n");
      out.write("\t\t\t<div class=\"form-group py-2\">\n");
      out.write("                             <label \n");
      out.write("                  class=\"col-md-4 col-form-label text-md-right\">Nhập Email<font color=\"red\">*</font></label>\n");
      out.write("\t\t\t\t<div class=\"input-field\"> <span class=\"far fa-user p-2\"></span> <input type=\"text\" placeholder=\"Nhập Email của bạn\" name =\"username\" required class=\"\"> </div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t <button type=\"submit\" class=\"btn btn-block text-center my-2 \" style=\"display: block;\n");
      out.write("\t\t\t margin-left: auto;\n");
      out.write("\t\t\t margin-right: auto;\n");
      out.write("\t\t\t width: 40%;\">Reset Password</button>\n");
      out.write("\t\t</form>\n");
      out.write("\t</div>\n");
      out.write("</body>\n");
      out.write("\n");
